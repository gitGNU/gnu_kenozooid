...
RAW_DATA_OSTC_191_HW = ku._dump_decode(OSTC_191_HW_DATA)
RAW_DATA_OSTC_194 = ku._dump_decode(OSTC_194_DATA)
RAW_DATA_OSTC_196 = ku._dump_decode(OSTC_196_DATA)
...
class MemoryDumpTestCase(unittest.TestCase):
    ...
    def test_version_191(self):
        ...
        """
        dc = OSTCMemoryDump()
        ver = dc.version(RAW_DATA_OSTC_191_HW)
        self.assertEquals('OSTC Mk.2 1.91', ver)

        ver = dc.version(RAW_DATA_OSTC_194)
        self.assertEquals('OSTC Mk.2 1.94', ver)

        ver = dc.version(RAW_DATA_OSTC_196)
